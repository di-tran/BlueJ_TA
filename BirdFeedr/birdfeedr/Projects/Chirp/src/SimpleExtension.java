 ...
 */
public class SimpleExtension extends Extension implements CompileListener {
    /*
    ...
    public void compileSucceeded(CompileEvent event) {
        try {
            playSound("lib/extensions/Chirp.wav");
            //JOptionPane.showMessageDialog(null, "Insert chirp sound here.");
        } catch (Exception e) {
            e.printStackTrace();
        }
        //JOptionPane.showMessageDialog(null, "Insert chirp sound here.");

 ...
 */
public class TestExtension extends Extension implements PackageListener,CompileListener {
    /*
    ...
    public void compileStarted(CompileEvent event) 
    {
        ...
        String pathToClojure = System.getProperty( "clojure.jar" );
        l.addURL( new java.io.File(pathToClojure).toURL());
        String clojureSourcesDir = System.getProperty("user.dir");
        l.addURL( new java.io.File(clojureSourcesDir).toURL());
         Thread.currentThread().setContextClassLoader(l);
         
        System.setProperty( "clojure.compile.path", clojureSourcesDir );
        
        Class<?> clazz = Class.forName("clojure.lang.Compile", true, l);
        java.lang.reflect.Method meth = clazz.getMethod("main", String[].class);
        String[] params = new String[]{"test.basic"}; // init params accordingly
        meth.invoke(null, (Object) params); // static method doesn't have an instance
        Class<?> clazz2 = Class.forName("test.basic", true, l);
        System.out.println("clazz2: " + clazz2 );
        meth = clazz2.getMethod("main", String[].class);

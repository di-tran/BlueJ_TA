 ...
 */
public class GitPullAction extends GitProjectAction {
     ...
     */
    public GitPullAction(String menuName, String msg, BPackage aPackage)
    ...
    public void actionPerformed(ActionEvent anEvent) {
        ...
        try {
        GitHelper.runPullCommand( this.projectFolder, "Message" );
        }
        catch ( Exception e )
        {
            e.printStackTrace();
